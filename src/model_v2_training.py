...
model = DistilBertForSequenceClassification.from_pretrained("src/models/v2", num_labels=7)
...
training_args = TrainingArguments(
    output_dir="src/models/results_v3",
...
model.save_pretrained("src/models/v3")
